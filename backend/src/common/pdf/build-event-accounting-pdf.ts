...
export function buildEventAccountingPdf(
  summary: EventAccountingSummaryDto,
  ...
  return {
    ...
    header: {
      columns: [
        ...
        },
        {
          stack: [
            {
              text: 'ASOCIACION DE ARTESANOS "IUIAI WASI"',
              alignment: 'center',
              style: 'orgHeader',
            },
            {
              text: 'Resguardo Inga de Condagua',
              alignment: 'center',
              style: 'orgSubHeader',
            },
          ],
    ...
    content: [
      {
        text: 'RESUMEN CONTABLE DEL EVENTO',
        style: 'header',
        alignment: 'center',
        margin: [0, 0, 0, 10],
      },
                ...
                ...artisan.sales.map((sale) => [
                  ...
                  sale.paymentMethod === 'CASH'
                    ...
                    : sale.paymentMethod === 'CARD'
                      ...
                      : sale.paymentMethod || '',
                  sale.cardFee
                    ? sale.cardFee.toLocaleString('es-CO', {
            ...
            table: {
              ...
              body: [
                [
                  ...
                  {
                    text: `$${artisan.totalSold.toLocaleString('es-CO', { minimumFractionDigits: 2 })}`,
                    alignment: 'right',
                  },
                ],
                [
                  { text: 'Total fee datafono', bold: true },
                  {
                    text: `$${artisan.totalCardFees.toLocaleString('es-CO', { minimumFractionDigits: 2 })}`,
                    alignment: 'right',
                  },
                ],
                [
                  { text: 'Comisión Asociación', bold: true },
                  {
                    text: `$${artisan.commissionAssociation.toLocaleString('es-CO', { minimumFractionDigits: 2 })}`,
                    alignment: 'right',
                  },
                ],
                [
                  { text: 'Comisión Vendedor', bold: true },
                  {
                    text: `$${artisan.commissionSeller.toLocaleString('es-CO', { minimumFractionDigits: 2 })}`,
                    alignment: 'right',
                  },
                ],
                [
                  { text: 'Neto recibido', bold: true, fillColor: '#e0e0e0' },
                  {
                    text: `$${artisan.netReceived.toLocaleString('es-CO', { minimumFractionDigits: 2 })}`,
                    alignment: 'right',
                    fillColor: '#e0e0e0',
                  },
                ],
        ...
        table: {
          ...
          body: [
            [
              { text: 'Total vendido', bold: true },
              {
                text: `$${summary.totalSold.toLocaleString('es-CO', { minimumFractionDigits: 2 })}`,
                alignment: 'right',
              },
            ],
            [
              { text: 'Total fee datafono', bold: true },
              {
                text: `$${summary.totalCardFees.toLocaleString('es-CO', { minimumFractionDigits: 2 })}`,
                alignment: 'right',
              },
            ],
            [
              { text: 'Comisión Asociación', bold: true },
              {
                text: `$${summary.totalCommissionAssociation.toLocaleString('es-CO', { minimumFractionDigits: 2 })}`,
                alignment: 'right',
              },
            ],
            [
              { text: 'Comisión Vendedor', bold: true },
              {
                text: `$${summary.totalCommissionSeller.toLocaleString('es-CO', { minimumFractionDigits: 2 })}`,
                alignment: 'right',
              },
            ],
            [
              { text: 'Neto recibido', bold: true, fillColor: '#e0e0e0' },
              {
                text: `$${summary.totalNetReceived.toLocaleString('es-CO', { minimumFractionDigits: 2 })}`,
                alignment: 'right',
                fillColor: '#e0e0e0',
              },
            ],
